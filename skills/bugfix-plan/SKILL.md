...
the graph, modify project rule files, diagnose the final root cause, or write
the plan. The primary confirms critical evidence and owns root-cause analysis,
